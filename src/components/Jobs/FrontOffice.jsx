...
import FiltersFrontOffice from '../Filters/Jobs/FiltersFrontOffice';
...
const carBrands = [
    ...
    "Office Admin (1853)",
    "Secretary (104)",
    "Assistant Office Manager (71)",
    "Front Desk Representative (3)",
    "Back Office (1)"


];
const car = {
    price: "Front Office Assistant",
    title: "Confidential",
    location: "AED ",
    location1: "2,000 - 3,999",
...
const ForntOffice = () => {
    ...
    const visibleBrands = showMore ? carBrands.slice(0, 10) : carBrands.slice(0, 7);
                ...
                <div>
                    <div className="px-5 py-8" style={{ paddingBottom: "0px" }}>
                        ...
                        <div className="flex items-center text-sm text-gray-500 space-x-1">
                            ...
                            <ChevronRight className="w-4 h-4" />
                            <span> Secretarial / Front Office </span>
                        </div>
                        <div className="flex justify-between items-start flex-wrap md:flex-nowrap gap-4 mb-4">

                            <h1 className="mt-2 text-xl font-semibold text-gray-900">
                                <span className="font-bold">Secretarial / Front Office Jobs in UAE, UAE</span>
                                <span className="font-normal text-gray-600"> • 142 Ads</span>
                            </h1>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <div className="bg-gray-100 px-4 py-2 rounded text-xs font-semibold text-gray-700">
                                        ...
                                        <div className="text-sm font-semibold text-gray-800">0-1 Years</div>
                                    </div>
                                ...
                                <div className="flex items-center text-sm space-x-3 mt-1">
                                    <span className="text-green-600 font-medium">Posted 5 hours ago</span>
