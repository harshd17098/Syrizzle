...
const baths = ["1","2", "3", "4", "5", "6+"];


const FiltersOffPlane = () => {
                    ...
                    {isOpenn && (
                        <div className="absolute z-10 mt-2 w-[418px] right-0 bg-white border border-gray-200 shadow-xl rounded-xl flex flex-col max-h-[600px] overflow-auto">
                            <div className="mb-6 ml-4 mr-4 mt-4">
                                <h2 className="font-semibold mb-3" style={{fontSize:'14px'}}>Baths</h2>
                            ...
                            <div className="mb-6 ml-4 mr-4">
                                {/* Area / Size */}
                                <div>
                                    <h2 className="text-lg font-semibold mb-2" style={{fontSize:'14px'}}>Area / Size (Sqft)</h2>
                            ...
                            {/* Amenities */}
                            <div className="mb-6 ml-4 mr-4">
                                <h2 className="text-lg font-semibold mb-2" style={{fontSize:'14px'}}>Amenities</h2>
                                <div className="flex flex-wrap gap-2">
                                    {displayedAmenities.map((item, idx) => (
                                        <button
                                            key={idx}
                                            className="px-3 py-1 text-sm border border-gray-300 hover:bg-[rgb(242,247,254)] hover:border-[rgb(137,184,246)] rounded-full "
                                        >
                                            {item}
                                        </button>
                                    ))}
                                    <button
                                        ...
                                        className="px-3 py-1 text-sm border border-gray-300 rounded-full text-blue-600hover:bg-[rgb(242,247,254)] hover:border-[rgb(137,184,246)]"
                                    >
                            ...
                            {/* Keywords */}
                            <div className="mb-6 ml-4 mr-4">
                                <h2 className="text-lg font-semibold mb-2" style={{fontSize:'14px'}}>Keywords</h2>
                                <input
                                    type="text"
                            ...
                            {/* Listed By */}
                            <div className="mb-6 ml-4 mr-4">
                                <h2 className="text-lg font-semibold mb-2" style={{fontSize:'14px'}}>Listed By</h2>
                                <div className="flex gap-3">
                                    {['Agent', 'Landlord', 'Developer'].map((label, idx) => (
                                        <button
                                            key={idx}
                                            className="px-4 py-1 border border-gray-300 hover:bg-[rgb(242,247,254)] hover:border-[rgb(137,184,246)] rounded-full"
                                        >
                                            {label}
                                        </button>
                                    ))}
                            ...
                            <div className="mb-6 ml-4 mr-4">
                                <h2 className="text-lg font-semibold mb-2" style={{fontSize:'14px'}}>Real Estate Agencies</h2>
                                <input
                                    type="text"
                            ...
                            {/* Rent is Paid */}
                            <div className="mb-6 ml-4 mr-4">
                                <h2 className="text-lg font-semibold mb-2" style={{fontSize:'14px'}}>Rent is Paid</h2>
                                <div className="flex gap-3">
                                    {['Furnished', 'Unfurnished'].map((label, idx) => (
                                        <button
                                            key={idx}
                                            className="px-3 py-1 border border-gray-300 rounded-full hover:bg-[rgb(242,247,254)] hover:border-[rgb(137,184,246)]"
                                        >
                                            {label}
                                        </button>
                                    ))}
                            ...
                            {/* Other Filters */}
                            <div className="mb-6 ml-4 mr-4">
                                <h2 className="text-lg font-semibold mb-2" style={{fontSize:'14px'}}>Other Filters</h2>
...
export default FiltersOffPlane;