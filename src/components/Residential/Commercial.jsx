...
const car = {
    ...
    specs: "GCC Specs",
    imageUrls: [
        "https://dbz-images.dubizzle.com/images/2025/03/06/5c6e1423-1931-465e-bf2b-88ffe5cfaf4e/77dd533cd31b41d1a4e89d7d5e7a30c7-.jpg?impolicy=lpv",
        "https://dbz-images.dubizzle.com/images/2025/03/06/e6eee4d8-d2e3-4558-bbb0-95e55f2d5d52/872daa991f05452c821fd1ac505956a9-.jpg?impolicy=dpv",
        "https://dbz-images.dubizzle.com/images/2025/03/06/5c6e1423-1931-465e-bf2b-88ffe5cfaf4e/5e181122c20049a5babb5a5845f1a84d-.jpg?impolicy=dpv",
        "https://dbz-images.dubizzle.com/images/2025/03/06/5c6e1423-1931-465e-bf2b-88ffe5cfaf4e/ae2bfcbe53c04c7d97381de02ecd4f90-.jpg?impolicy=dpv",
        "https://dbz-images.dubizzle.com/images/2025/03/06/5c6e1423-1931-465e-bf2b-88ffe5cfaf4e/88771bc43b694b14aa62133c306dfef3-.jpg?impolicy=dpv",
        "https://dbz-images.dubizzle.com/images/2025/03/06/5c6e1423-1931-465e-bf2b-88ffe5cfaf4e/871a5cb23e9b4ec2aa8bdbb3b2fd7db8-.jpg?impolicy=dpv",
    ],
};
const Commercial = () => {
                ...
                <div>
                    <div className="px-5 py-8">
                        ...
                        <div className="flex items-center text-sm text-gray-500 space-x-1">
                            ...
                            <ChevronRight className="w-4 h-4" />
                            <span>Commercial properties for rent in UAE</span>
                        </div>
                        <div className="flex justify-between items-start flex-wrap md:flex-nowrap gap-4 mb-4">

                            <h1 className="mt-2 text-xl font-semibold text-gray-900">
                                <span className="font-bold">Commercial buildings for rent in UAE</span>
                                <span className="font-normal text-gray-600"> • 19,546 Ads</span>
                            </h1>
