...
const FiltersBusinessDevelopment = () => {
                        ...
                        >
                            ...
                            <div className="overflow-y-auto px-4 pt-4 pb-2" style={{ maxHeight: "calc(600px - 72px)" }}>
                                ...
                                <div className=" w-full max-w-md bg-white rounded-lg ">
                                    ...
                                    <hr className="my-3" />
                                    <div className="mb-7 mt-7">
                                        <h4 className="text-sm font-semibold text-gray-800 mb-2">Sub Category</h4>
                                        <div className="relative">
                                            <input
                                                type="text"
                                                placeholder="Search"
                                    ...
                                    <div className="mb-7 mt-7">
                                        ...
                                        <div className="relative">
                                            <input
                                                type="text"
                                                placeholder="All in Engineering"
                                                className="
                                              w-full border rounded-md px-3 py-2 pl-8 text-sm h-10
                                              focus:outline-none focus:ring-0
                                              focus-visible:outline-none focus-visible:ring-0
...
export default FiltersBusinessDevelopment;