...
const car = {
    price: "Outdoor Sales Executive",
    title: "LED CORNER TRADING LLC",
    location: "AED ",
                    ...
                    <div className="px-5 py-8" style={{ paddingBottom: "0px" }}>
                        ...
                        <div className="flex justify-between items-start flex-wrap md:flex-nowrap gap-4 mb-4">
                            ...
                            <h1 className="mt-2 text-xl font-semibold text-gray-900">
                                <span className="font-bold">Sales / Business Development Jobs in UAE, UAE</span>
                                <span className="font-normal text-gray-600"> • 369 Ads</span>
                            </h1>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <div className="bg-gray-100 px-4 py-2 rounded text-xs font-semibold text-gray-700">
                                        ...
                                        <div className="text-sm font-semibold text-gray-800">1-2 Years</div>
                                    </div>
                                ...
                                <div className="flex items-center text-sm space-x-3 mt-1">
                                    <span className=" font-medium" style={{color:"green"}}>Posted 2 hours ago</span>
