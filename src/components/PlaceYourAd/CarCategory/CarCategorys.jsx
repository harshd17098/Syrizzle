...
const CarCategorys = () => {
    ...
    const [formSubmitted, setFormSubmitted] = useState(
        dataReceived?.formSubmitted || false
    );
    ...
    const [responseData, setResponseData] = useState(
        dataReceived?.responseData || null
    );
    ...
    const displayedFeatures = showAll
        ? features.slice(0, 15)
        : features.slice(0, 5);
    const displayedExtras = showAllExtras
        ? extras.slice(0, 15)
        : extras.slice(0, 5);
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((err) => {
                setError(
                    err.response?.data?.message || "Failed to fetch exterior colors."
                );
            });
    }, [token]);
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((err) => {
                setError(
                    err.response?.data?.message || "Failed to fetch interior colors."
                );
            });
    }, [token]);
    ...
    useEffect(() => {
        ...
        axios
            ...
            .catch((err) => {
                setError(
                    err.response?.data?.message || "Failed to fetch transmission types."
                );
            });
    }, []);
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                setHorsepowerList(response.data.data.result);
            })
            .catch((err) => {
                setError(
                    err.response?.data?.message || "Failed to fetch horsepower data."
                );
            });
    }, []);
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                setFeatures(response.data.data.result);
            })
            .catch((err) => {
                setError(
                    err.response?.data?.message || "Failed to fetch technical features."
                );
            });
    }, []);
    ...
    const handleRemoveImage = (indexToRemove) => {
        ...
        setPayload((prev) => {
            const newPaths = (prev.images || []).filter(
            ...
            {!formSubmitted ? (
                <div className="w-full max-w-md space-y-4">
                    ...
                    <div className="flex items-center text-sm space-x-1 mb-6">
                        <Link
                            to={"/place-an-ad/taxonomy/motors/"}
                                ...
                                {responseData && (
                                    ...
                                    >
                                        <div className="flex justify-between items-center mb-4">
                                            <h2
                                                className="text-xl"
                                                style={{ color: "rgb(66, 70, 72)" }}
                                            >
                                                Listing Summary
                                            </h2>
                                            <Link
                                                to={`/place-an-ad/motors/used-cars/new/edit/?_id=${motorId}`}
                                            >
                                                <button
                                                    style={{ color: "rgb(224, 0, 0)", fontSize: "20px" }}
                                                >
                                                    Edit
                                                </button>
                                            </Link>
                                        ...
                                        >
                                            ...
                                            <span className="font-semibold">
                                                {getModelNameById(responseData.model_id)}
                                            </span>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <span className="font-semibold">
                                                {getTrimNameById(responseData.trim_id)}
                                            </span>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <span className="font-semibold">
                                                {getRegionalSpecNameById(responseData.regional_spec_id)}
                                            </span>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <span className="font-semibold">
                                                {getBodyTypeNameById(responseData.body_type_id)}
                                            </span>
                                        </div>
                                ...
                                <div className="space-y-4 max-w-md mx-auto">
                                    ...
                                    <div className="relative w-full">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setPayload({ ...payload, tour_360: e.target.value })
                                            }
                                        />
                                        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-sm text-gray-500 italic">
                                            *Optional
                                        </span>
                                    </div>
                                    ...
                                    <div className="w-full">
                                        ...
                                        <select
                                            ...
                                            onChange={(e) =>
                                                setPayload({ ...payload, fuel_type: e.target.value })
                                            }
                                        >
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setPayload({
                                                ...payload,
                                                exterior_color_id: e.target.value,
                                            })
                                        }
                                    >
                                        <option value="" disabled hidden>
                                    ...
                                    <div className="w-full max-w-md">
                                        <select
                                            ...
                                            onChange={(e) =>
                                                setPayload({
                                                    ...payload,
                                                    interior_color_id: e.target.value,
                                                })
                                            }
                                        >
                                            <option value="" disabled hidden>
                                            ...
                                            {Array.isArray(InteriorColor) &&
                                                InteriorColor.map((color, index) => (
                                                    <option key={index} value={color._id}>
                                                        {color.name}
                                                    </option>
                                                ))}
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setPayload({ ...payload, warranty: e.target.value })
                                        }
                                    >
                                    ...
                                    <select
                                        ...
                                        value={payload.doors}
                                        onChange={(e) =>
                                            setPayload({ ...payload, doors: e.target.value })
                                        }
                                    >
                                        <option value="" disabled selected hidden>
                                            Doors *
                                    ...
                                    <div className="w-full max-w-md">
                                        ...
                                        >
                                            ...
                                            {Array.isArray(horsepowerList) &&
                                                horsepowerList.map((item, index) => (
                                                    <option key={index} value={item._id}>
                                                        {item.name}
                                                    </option>
                                                ))}
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setPayload({ ...payload, steering_side: e.target.value })
                                        }
                                    >
                                        <option value="" disabled selected hidden>
                                            Steering Side *
                                        ...
                                        >
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">
                                                    {[addr.apartment, addr.building, addr.neighbourhood]
                                                        .filter(Boolean)
                                                        .join(", ")}
                                                </p>
                                                <div>
                                                ...
                                                <div className="flex space-x-2 mb-4">
                                                    {[
                                                        ...
                                                        <button
                                                            key={type}
                                                            onClick={() =>
                                                                handleLabel(label.toLowerCase(), type)
                                                            }
                                                            className={`px-3 py-1 border rounded ${formDat.address_type === type
                                                                ? "bg-blue-100"
                                                                : ""
                                                                }`}
                                                        >
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full py-3 mt-8 text-white bg-red-600 rounded-md"
                                    >
                                        Submit
                                    </button>
                                </div>
