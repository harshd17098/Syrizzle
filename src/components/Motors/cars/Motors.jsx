...
const Motors = () => {
    ...
    const getData = async () => {
        ...
        const payload = {
            page: page,
            limit: 10,
            ...(city && city !== cities[0] && { emirate: city }),
            steering_side: ['Left Hand']
        }

        const response = await apiPost(motors.filter, payload);
    ...
    return (
        <>
            <section className="px-4 py-6">
                ...
                <div className="max-w-5xl items-start space-y-5" style={{ width: "915px" }}>
                    {allData?.map((list, i) => {
                        const prevButtonId = `custom-prev-${i}`;
                        const nextButtonId = `custom-next-${i}`;
                        const paginationId = `swiper-pagination-${i}`;
                        return (
                    ...
                    `}</style>
                                    ...
                                    <div id={paginationId} className="swiper-pagination absolute bottom-1 w-full text-center z-10" />
                                </div>

                                <div className="flex-1 w-full">
                                    <div className="flex justify-between items-start">
                                        <h2 className="mb-2 text-xl md:text-2xl font-semibold line-clamp-1">AED {list.price}</h2>
                                        <span
                                    ...
                                    <div className="flex flex-wrap gap-4 mt-3 text-gray-700 text-sm md:text-base items-center relative">
                                        <div className="flex items-center gap-1">
                                            <h1 className="text-xl"><MdOutlineCalendarMonth /></h1>
                                            {car.year}
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <h1 className="text-xl"><MdOutlineSpeed /></h1>
                                            {car.mileage}
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <h1 className="text-xl"><RiSteering2Fill /></h1>
                                            {car.hand}
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <h1 className="text-xl"><TbWorld /></h1>
                                            {car.specs}
                                        </div>
