...
import FiltersWatches from '../Filters/Classifieds/FiltersWatches'
...
const carBrands = [
    "Watches (7520)",
    "Women's Jewelry (1569)",
    "Men's Jewelry (578)",
    "Other (360)",
    "Loose Diamonds & Gems (236)",
    "Umm Al Qawain (774)",
    "Al Ain (67)",
    "Fujeirah (16)",
];
...
const car = {
    price: "Audemars Piguet Royal Oak Watch - 15500 grey Dial ",
    title: "Watches . Men's Watches",
    location: "AED 145,000",
    location1: "2 baths",
    location2: "768 sqft",
    ...
    specs: "GCC Specs",
    imageUrls: [
        "https://dbz-images.dubizzle.com/images/2025/05/05/d8db48df81c341b0975b47b763417d75-.png?impolicy=dpc",
        "https://dbz-images.dubizzle.com/images/2025/05/05/881448b85b4a46ed81cc8b2a61a48116-.jpeg?impolicy=dpc",
        "https://dbz-images.dubizzle.com/images/2025/05/05/b98c7fa4aa87406f98ec4933babedc8b-.jpeg?impolicy=dpc",
        "https://dbz-images.dubizzle.com/images/2025/05/05/fd913b6f1820406b925a93b217aefdc3-.png?impolicy=dpc",
                    ...
                    <div className="px-5 py-8" style={{ paddingBottom: "0px" }}>
                        ...
                        <div className="flex justify-between items-start flex-wrap md:flex-nowrap gap-4 mb-4">
                            ...
                            <h1 className="mt-2 text-xl font-semibold text-gray-900">
                                <span className="font-bold">New and Used Jewelry & Watches  for sale in UAE</span>
                                <span className="font-normal text-gray-600"> • 10,555 Ads</span>
                            </h1>
                    ...
                    <div className="flex-1 w-full">
                        ...
                        <div className="flex items-center gap-1 text-gray-600 text-sm mb-2">
                            <img
                                ...
                                className="w-4 h-4"
                            />
                            <span className="text-black font-medium">Dubai Hills Estate, Dubai</span>
                            <span>•</span>
