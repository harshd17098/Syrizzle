                    ...
                    {isOpenn && (
                        <div className="absolute z-10 mt-2 w-[418px] right-0 bg-white border border-gray-200 shadow-xl rounded-xl flex flex-col max-h-[600px] overflow-auto">
                            <div className="mb-6 ml-4 mr-4 mt-4">
                                <h2 className="font-semibold mb-3">Baths</h2>
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <button
                                        onClick={() => setShowAllSeats(!showAllBaths)}
                                    ...
                                    >
                                        {showAllBaths ? "View Less" : "View More"}
                                    </button>
                                </div>
                            </div>
                            <hr className="my-3" />
                            <div className="mb-6 ml-4 mr-4">
                                {/* Area / Size */}
                                <div>
                                    <h2 className="text-lg font-semibold mb-2">Area / Size (Sqft)</h2>
